        ...
        <div class="col-md-8">
            <div class="box box-primary">
                <div class="box-header">
                    ...
                    <?= \backend\modules\posts\components\CkEditorWidgets::widget(['model'=>$model,'form'=>$form,'field'=>'mota1']); ?>
                    <?= \backend\modules\posts\components\CkEditorWidgets::widget(['model'=>$model,'form'=>$form,'field'=>'mota2']); ?>
                    <?= \backend\modules\posts\components\CkEditorWidgets::widget(['model'=>$model,'form'=>$form,'field'=>'mota3']); ?>
