        ...
        dmstr\widgets\Menu::widget(
                [
                    ...
                    'items' => [
                        ...
                        ['label' => 'Sản phẩm', 'icon' => 'fa fa-dashboard', 'url' => '#', 'visible' => Yii::$app->user->can('managePost'),
                            'items' => [
                                ['label' => 'Tạo sản phẩm', 'icon' => 'fa fa-file-text-o', 'url' => ['/sanpham/create']],
                                ['label' => 'Tất cả', 'icon' => 'fa fa-file-text-o', 'url' => ['/sanpham']],
                            ],
                        ],
